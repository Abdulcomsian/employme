...
class AuthenticationController extends Controller
{
    ...
    {
        return view('user-auth.passwords.forgot-password');
    }
    ...
    {
        return view('user-auth.passwords.reset-password', ['token' => $token]);
    }

    public function udpateResetPassword(Request $request)
    {
        $request->validate([
            'token' => 'required',
            'email' => 'required|email',
