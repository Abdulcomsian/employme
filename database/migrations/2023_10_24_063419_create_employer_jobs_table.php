...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('employer_jobs', function (Blueprint $table) {
            ...
            $table->enum('experience_level',['0-1 Year','1-3 Years','3-5 Years','5-7 Years','7-10 Years' , '10+'])->nullable();
            ...
            $table->string('teaching_hours_per_day')->nullable();
            $table->string('non_teaching_hours_per_day')->nullable();
