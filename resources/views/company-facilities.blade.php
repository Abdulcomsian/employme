...
@endpush
	...
	<ul id="menu-closed">
		...
		<li>	<a href="{{route('companyFacilities')}}"  class="active"> School Facilities</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xxl-9 col-xl-8 order-xl-first">
					...
					<div class="container">
						<h2>School Facilities & Environment</h2>
						<p>Infrastructure: (Details about classrooms, teaching aids, laboratories, libraries, etc.)</p>
						<p>Recreational Areas:  (Play areas, lounges, etc.)</p>
						<p>Technology Integration:  (E.g., smartboards, online learning platforms, computer labs)</p>
						<p>Safety Measures: (CCTV, security personnel, fire safety equipment, etc.)</p>
