...
<div class="main-hero bg-purple">
    <section class="section padding-bottom-medium">
        ...
        <div class="container header w-container">
          <div class="w-layout-grid main-grid">
              ...
              <div class="hero-cta-wrapper margin-bottom-xsmall">
                <div class="form-wrapper">
                  <div class="full-form w-form">
                    <form id="search-btn" name="wf-form-Email-Hero" data-name="Email Hero" method="get"
                      class="form single" data-wf-page-id="64cb35cd05058fe9b18f5798"
                      data-wf-element-id="6a2fefe4-3854-232c-5cc0-bbdb809a3280"><input type="email"
                        class="text-field w-input" maxlength="256" name="Email-5" data-name="Email 5"
                        placeholder="Search Job Keywords" id="search" required=""><input type="submit" value=""
                        data-wait="Please wait..." class="button small w-button"></form>
            ...
            <div id="w-node-_61666704-67e4-53b5-2126-8750936417d0-b18f5798" class="content-wrapper">
              ...
              <a href="#" class="button-circle w-inline-block hire bg-remove-hover">
      ...
      <div class="w-layout-grid main-grid gallery">
        <div id="w-node-_597b5782-9c5d-c351-155c-f0935ccfea19-b18f5798" data-w-id="597b5782-9c5d-c351-155c-f0935ccfea19"
          class="vertical-rail _001">
            <div class="image-hero-wrapper radius">
    <img src="{{ asset('assets/images/vertical-shot-cheerful-dark-skinned-unshaven-man-looks-positively-upwards-being-good-mood.jpg') }}"
         loading="lazy"
         sizes="(max-width: 991px) 256px, 224px"
         ...
         class="cover-image">
          ...
          <div class="image-hero-wrapper _005"><img src="{{asset('assets/images/ui-062.svg')}}" loading="lazy" alt=""
              class="cover-image"></div>
        </div>
        <div id="w-node-c28216ed-64d1-4a15-5bad-3aa5fd046d54-b18f5798" data-w-id="c28216ed-64d1-4a15-5bad-3aa5fd046d54"
          class="vertical-rail middle">
    ...
    <img src="{{ asset('assets/images/indoor-portrait-young-female-posing-red-background-laugh-keep-her-eyes-closed.jpg') }}"
         loading="lazy"
         sizes="(max-width: 479px) 100vw, (max-width: 991px) 18vw, 308px"
...
<div class="image-hero-wrapper">
    <img src="{{ asset('assets/images/portrait-handsome-man-with-sunglasses-orange-background.jpg') }}"
         loading="lazy"
         sizes="(max-width: 479px) 100vw, (max-width: 767px) 92vw, (max-width: 991px) 94vw, 96vw"
        ...
        <div class="image-hero-wrapper radius">
    <img src="{{ asset('assets/images/74.jpg') }}"
         loading="lazy"
         sizes="(max-width: 991px) 256px, 224px"
        ...
        <div id="w-node-_436b2aba-b60b-e6d9-59e2-8e3841f13566-b18f5798" class="vertical-rail bottom">
          ...
          <div class="image-hero-wrapper circle">
    <img src="{{ asset('images/Frame-98.png') }}"
         loading="lazy"
         sizes="(max-width: 479px) 100vw, (max-width: 991px) 18vw, 308px"
         srcset="{{ asset('assets/images/Frame-98-p-500.png') }} 500w, {{ asset('images/Frame-98-p-800.png') }} 800w, {{ asset('images/Frame-98.png') }} 1399w"
         alt=""
         class="cover-image">
</div>
  ...
  <section class="section bg-gray padding-bottom-small">
      ...
      <div id="w-node-_59a6c22b-8d1b-c5a4-5cbb-e1f5a8063d14-b18f5798" class="gap-wrapper">
        ...
        <div class="rounded-block">
          <div class="w-layout-grid main-grid">
            ...
            <div id="w-node-_1dc1b062-d679-2ced-19b1-9ba419d15ddf-b18f5798" class="graphics-wrapper">
            <div class="scale-up">
    <img src="{{ asset('assets/images/ui-036.png') }}" loading="lazy"
         sizes="(max-width: 479px) 100vw, (max-width: 767px) 80vw, (max-width: 991px) 84vw, 87vw"
         srcset="{{ asset('assets/images/ui-036-p-500.png') }} 500w, {{ asset('assets/images/ui-036-p-800.png') }} 800w, {{ asset('assets/images/ui-036-p-1080.png') }} 1080w, {{ asset('assets/images/ui-036-p-1600.png') }} 1600w, {{ asset('assets/images/ui-036.png') }} 1861w"
         alt=""
         class="contain-image"
    >
</div>
        ...
        <div class="w-layout-grid main-grid margin-bottom-small">
          ...
          <div id="w-node-df6b7e03-bb73-87a9-bfd4-1931cd31486f-b18f5798"
            data-w-id="df6b7e03-bb73-87a9-bfd4-1931cd31486f"
            style="opacity:0;-webkit-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
            class="gray-wrapper custom-gray-warpper icons no-hover">
          ...
          <div id="w-node-df6b7e03-bb73-87a9-bfd4-1931cd314877-b18f5798"
            data-w-id="df6b7e03-bb73-87a9-bfd4-1931cd314877"
            style="opacity:0;-webkit-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
            class="gray-wrapper custom-gray-warpper icons no-hover">
          ...
          <div id="w-node-df6b7e03-bb73-87a9-bfd4-1931cd31487f-b18f5798"
            data-w-id="df6b7e03-bb73-87a9-bfd4-1931cd31487f"
            style="opacity:0;-webkit-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
            class="gray-wrapper custom-gray-warpper icons no-hover">
          ...
          <div id="w-node-df6b7e03-bb73-87a9-bfd4-1931cd314867-b18f5798"
            data-w-id="df6b7e03-bb73-87a9-bfd4-1931cd314867"
            style="opacity:0;-webkit-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 3em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
            class="gray-wrapper custom-gray-warpper icons no-hover">
            ...
            <div
              ...
              <p class="p-small">Avoid dealing with recruiters and connect directly with your future employer <br> <span
                  style="color: white;"> no more content</span></p>
            </div>
          </div>
        ...
        <div class="rounded-block bg-purple gap">
          <div class="overflow-grid plan">
            <div class="w-layout-grid main-grid">
              <div id="w-node-c894ce13-db6d-6b27-2d28-4d0eeebe00e9-b18f5798"
                data-w-id="c894ce13-db6d-6b27-2d28-4d0eeebe00e9" class="box-wrapper plan recommended  no-hover">
              ...
              <div id="w-node-c894ce13-db6d-6b27-2d28-4d0eeebe0111-b18f5798"
                data-w-id="c894ce13-db6d-6b27-2d28-4d0eeebe0111" class="box-wrapper plan no-hover">
                <div class="w-layout-grid inner-grid-plan">
                  <div class="content-wrapper">
              ...
              <div id="w-node-c894ce13-db6d-6b27-2d28-4d0eeebe0152-b18f5798"
                data-w-id="c894ce13-db6d-6b27-2d28-4d0eeebe0152" class="box-wrapper plan no-hover">
                <div class="w-layout-grid inner-grid-plan">
                  <div class="content-wrapper">
        ...
        <div class="rounded-block bg-white">
          <div class="w-layout-grid main-grid z-index">
            <div id="w-node-_6428d815-43b4-48d9-ca9f-b5ac915898de-b18f5798"
              data-w-id="6428d815-43b4-48d9-ca9f-b5ac915898de" class="center-wrapper">
              <div
              ...
              <div
                style="-webkit-transform:translate3d(0, 5em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 5em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 5em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 5em, 0) scale3d(0.8, 0.8, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
                class="h-wrapper">
                <div class="heading-large inner-padding-micro">Join The Platform Now</div>
              </div>
              <div
                style="margin-top: 10px;  -webkit-transform:translate3d(0, 5em, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 5em, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 5em, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 5em, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)"
                class="button-wrapper">
    ...
    <img src="{{ asset('assets/images/ui-038.png') }}" loading="lazy"
         sizes="(max-width: 479px) 100vw, (max-width: 767px) 69vw, (max-width: 991px) 73vw, 75vw"
         srcset="{{ asset('assets/images/ui-038-p-500.png') }} 500w, {{ asset('assets/images/ui-038-p-800.png') }} 800w, {{ asset('assets/images/ui-038-p-1080.png') }} 1080w, {{ asset('assets/images/ui-038-p-1600.png') }} 1600w, {{ asset('assets/images/ui-038-p-2000.png') }} 2000w, {{ asset('assets/images/ui-038.png') }} 2188w"
    ...
    <img src="{{ asset('assets/images/ui-017.png') }}" loading="lazy"
         style="-webkit-transform:translate3d(0, 8em, 0) scale3d(0.88, 0.88, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0"
         sizes="(max-width: 479px) 100vw, (max-width: 767px) 74vw, (max-width: 991px) 77vw, 37vw"
         srcset="{{ asset('assets/images/ui-017-p-500.png') }} 500w, {{ asset('assets/images/ui-017-p-800.png') }} 800w, {{ asset('assets/images/ui-017-p-1080.png') }} 1080w, {{ asset('assets/images/ui-017.png') }} 1548w"
         alt="" class="ui-image">
</div>
          ...
          <div class="card">
            <div class="inner-card">
              ...
              <div class="graphics-wrapper">
    <img src="{{ asset('assets/images/ui-019.png') }}" loading="lazy"
         style="-webkit-transform:translate3d(0, 8em, 0) scale3d(0.88, 0.88, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0"
         sizes="(max-width: 479px) 100vw, (max-width: 767px) 74vw, (max-width: 991px) 77vw, 37vw"
         srcset="{{ asset('assets/images/ui-019-p-500.png') }} 500w, {{ asset('assets/images/ui-019-p-800.png') }} 800w, {{ asset('assets/images/ui-019-p-1080.png') }} 1080w, {{ asset('assets/images/ui-019.png') }} 1548w"
         alt="" class="ui-image">
</div>
      ...
      <div class="rounded-block bg-purple-image">
        <div class="w-layout-grid main-grid">
          <div id="w-node-_5e747d09-f72a-02e8-e5ae-78d2476c889c-476c889a" class="center-wrapper inner-padding-small">
            ...
            <h3 class="heading-large margin-20 margin-bottom-small">Voice your opinions. Tell us what we can do <span
            ...
            <div class="form-block w-form">
              <form id="wf-form-Join-Musk-Form" name="wf-form-Join-Musk-Form" data-name="Join Musk Form" method="get"
                class="form gap" data-wf-page-id="64cb35cd05058fe9b18f5798"
                data-wf-element-id="5e747d09-f72a-02e8-e5ae-78d2476c88a0"><input type="text" class="text-field w-input"
                  ...
                  data-name="Email" placeholder="Enter your email" id="Email-4" required=""> <input type="text"
                  class="text-field w-input" maxlength="256" name="Name" data-name="Name" placeholder="What can we do?"
                  id="Name" required=""><input type="submit" value="" data-wait="Please wait..."
                  class="button-circle-medium w-button"></form>
