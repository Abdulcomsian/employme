...
<div class="inner-banner-one position-relative">
		  ...
		  <nav class="nav-2" id="menu">
			<ul id="menu-closed">
			  ...
			  <li><a href="{{route('companyPrograms')}}" class="active">Programs and Curriculum</a></li>
				...
				<div class="col-xxl-9 col-xl-8 order-xl-first">
					<div class="details-post-data me-xxl-5 pe-xxl-4">
						...
						<div class="container">
							...
							<p>Course Offerings:** (Details about different courses or programs offered, their objectives, and methodologies)</p>
							<p>Extra-Curricular Activities:** (Details about clubs, sports, arts, and other non-academic activities)
							</p>
						</div>
						<div class="details">
							<p>
