        ...
        <div class="bg-white card-box border-20">
            ...
            <form action="{{route('employer.updateBusinessOperation')}}" method="POST" enctype= "multipart/form-data">
                ...
                <div class="row time-field-row" >
                    <div class="col-lg-3">
                        ...
                        <select name="operation_time[{{$index}}][day]" class="form-select">
                                <option value="Monday" {{$operationTime['day'] == 'Monday' ? 'selected' : ''}}>Monday</option>
                                <option value="Tuesday" {{$operationTime['day'] == 'Tuesday' ? 'selected' : ''}}>Tuesday</option>
                                <option value="Wednesday" {{$operationTime['day'] == 'Wednesday' ? 'selected' : ''}}>Wednesday</option>
                                <option value="Thursday" {{$operationTime['day'] == 'Thursday' ? 'selected' : ''}}>Thursday</option>
                                <option value="Friday" {{$operationTime['day'] == 'Friday' ? 'selected' : ''}}>Friday</option>
                    ...
                    <div class="col-lg-3">
                        <div class="dash-input-wrapper mb-20">
                            <input type="time" name="operation_time[{{$index}}][start_time]" value="{{$operationTime['start_time']}}" class = " @error('monday_start_time') is-invalid @enderror" placeholder="Day">
                    ...
                    <div class="col-lg-3">
                        <div class="dash-input-wrapper mb-20">
                            <input type="time" name="operation_time[{{$index}}][end_time]" value="{{$operationTime['end_time']}}" class = " @error('monday_end_time') is-invalid @enderror" placeholder="Day">
                ...
                <div class="row time-field-row" >
                    <div class="col-lg-3">
                        <div class="dash-input-wrapper mb-20">
                        <select name="operation_time[0][day]" class="form-select">
                    ...
                    <div class="col-lg-3">
                        <div class="dash-input-wrapper mb-20">
                            <input type="time" name="operation_time[0][start_time]" value="" class = " @error('monday_start_time') is-invalid @enderror" placeholder="Day">
                            @error('monday_start_time')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                    ...
                    <div class="col-lg-3">
                        <div class="dash-input-wrapper mb-20">
                            <input type="time" name="operation_time[0][end_time]" value="" class = " @error('monday_end_time') is-invalid @enderror" placeholder="Day">
                            @error('monday_end_time')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
