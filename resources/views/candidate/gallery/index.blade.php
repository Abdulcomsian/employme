        ...
        <div class="bg-white card-box border-20">
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="a1" role="tabpanel">
                    <div class="table-responsive">
                        <table class="table job-alert-table">
                            ...
                            <tr class="pending">
                                    ...
                                    @if($galleryImage->file_extension == 'mp4')
                                    <td><video  src="{{asset($galleryImage->file_name)}}"    width="120" height="80" controls></video></td>
                                    <td>Video</td>
                                    @else
                                    <td>
                                        <img id="image-preview" src="{{asset($galleryImage->file_name)}}"  height = "100" width = "100" alt="Image Preview">
                                    </td>
                                    <td>Image</td>
                                    @endif
                                    <td>
                                        <div class="action-dots float-end">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                               {{-- <li><a class="dropdown-item" href="#"><img src="{{asset('assets/images/lazy.svg')}}" data-src="{{asset('assets/images/icon/icon_18.svg')}}" alt="" class="lazy-img"> View</a></li>
                                                ...
                                                <li><a class="dropdown-item" href="{{route('gallery.edit', $galleryImage->id)}}"><img src="{{asset('assets/images/lazy.svg')}}" data-src="{{asset('assets/images/icon/icon_20.svg')}}" alt="" class="lazy-img"> Edit</a></li>--}}
                                                <li><a class="dropdown-item" href="#" onclick="event.preventDefault();
                                                                document.getElementById('destroy-form-{{$galleryImage->id}}').submit();"><img src="{{asset('assets/images/lazy.svg')}}" data-src="{{asset('assets/images/icon/icon_21.svg')}}" alt="" class="lazy-img"> Delete</a></li>
                                            </ul>
                                            <form id="destroy-form-{{$galleryImage->id}}" action="{{ route('gallery.destroy', $galleryImage->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
                    ...
                    {{ $galleryImages->links('vendor.pagination.custom-pagination-2') }}
        ...
        <div class="container">
            <div class="user-data-form modal-content">
                ...
                <div class="form-wrapper m-auto">
                    <form  id = "Interview-Request-Form" action = "{{route('gallery.store')}}" method = "POST" enctype = "multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-group-meta position-relative mb-25">
                                    ...
                                    <input type="file" name = "gallery_files[]" placeholder="" accept="image/jpeg,image/png,video/mp4" required multiple>
                                </div>
                            </div>
