...
<div class="dashboard-body">
    <div class="position-relative">
        ...
        <div class="bg-white card-box border-20">
            ...
            <h4 class="dash-title-three">Update Staff Member</h4>
            <form action="{{route('staff.update',$memberDetails->id)}}" method="POST" enctype= "multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-lg-6">
                        <div class="dash-input-wrapper mb-20">
                            ...
                            <input type="text" name="title" value="{{$memberDetails->title}}" class = " @error('title') is-invalid @enderror" placeholder="Zubayer">
                                @error('title')
                    ...
                    <div class="col-6">
                        <div class="dash-input-wrapper mb-20">
                            ...
                            <input type="text" name = "year_started" value = "{{$memberDetails->year_started}}" class="yearpicker @error('year_started') is-invalid @enderror" value="{{auth()->user()->email}}">
                                 @error('year_started')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="col-md-6">
                                <div class="dash-input-wrapper mb-30">
                                    ...
                                    <div class="d-flex user-avatar-setting  mb-30">
                                        ...
                                        <div class = "mx-4"><img id="image-preview" src="{{asset($memberDetails->staff_image)}}" class="" height = "100" width = "100" alt="Image Preview"></div>
