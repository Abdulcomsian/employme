      ...
      <div class="w-layout-grid main-grid-1 wf-grid">
        <div id="w-node-b7575744-a576-67bb-b83d-7346f92b9541-28bfa124" class="wrapper-sticky blog">
          <div class="w-dyn-list">
            <div role="list" class="w-dyn-items">
              <div data-dyn-label="Collection Item 1" role="listitem" class="w-dyn-item"><a
                  href="/post/7-ways-to-improve-website-usability-and-accessibility"
                  class="blog-link-wrapper w-inline-block">
                  <div class="wrapper-image-blog rounded"><img loading="lazy"
                      src="{{asset('assets/images/av-12.png')}}"
                      alt="" class="image-cms"></div>
        ...
        <div id="w-node-b85a6e33-96aa-3f7c-4e4e-000e7abdde9c-28bfa124">
          <div class="w-dyn-list">
            <div role="list" class="w-dyn-items">
              <div data-dyn-label="Collection Item 1" role="listitem" class="w-dyn-item"><a
                  href="/post/why-we-love-webflow-and-you-should-too" class="inner-grid-cms w-inline-block wf-grid">
                  <div class="wrapper-image-blog list rounded"><img
                      src="{{asset('assets/images/jj-jordan-hINQgaTqg7Q-unsplash.jpg')}}"
                      alt="" class="image-cms">
                  </div>
              ...
              <div data-dyn-label="Collection Item 2" role="listitem" class="w-dyn-item"><a
                  href="/post/7-must-have-tools-for-web-designers" class="inner-grid-cms w-inline-block wf-grid">
                  <div class="wrapper-image-blog list rounded"><img
                      src="{{asset('assets/images/jj-219094.png')}}"
                      alt="check" class="image-cms">
                  </div>
                  <div id="w-node-_99e36361-3e4e-2043-c2f4-d28c1533f32e-28bfa124">
                    <div class="title-tag text-red">Trends</div>
              ...
              <div data-dyn-label="Collection Item 3" role="listitem" class="w-dyn-item"><a
                  href="/post/7-of-the-best-examples-of-beautiful-blog-design"
                  class="inner-grid-cms w-inline-block wf-grid">
                  <div class="wrapper-image-blog list rounded"><img loading="lazy"
                      src="{{asset('assets/images/532563.png')}}"
                      alt="" class="image-cms">
                  </div>
                  <div id="w-node-_99e36361-3e4e-2043-c2f4-d28c1533f32e-28bfa124">
              ...
              <div data-dyn-label="Collection Item 4" role="listitem" class="w-dyn-item"><a
                  href="/post/5-web-design-blogs-you-should-be-reading" class="inner-grid-cms w-inline-block wf-grid">
                  <div class="wrapper-image-blog list rounded"><img
                      src="{{asset('assets/images/7561440.png')}}"
                      alt="" class="image-cms">
                  </div>
                  <div id="w-node-_99e36361-3e4e-2043-c2f4-d28c1533f32e-28bfa124">
                    <div class="title-tag text-red">Company News</div>
        ...
        <div class="w-layout-grid main-grid inner-padding-small">
          ...
          <div id="w-node-c2864e63-da07-45d7-a893-74ed488cfc2c-488cfc24" class="form-block center w-form mt-onehalf-em">
            <form id="wf-form-Newsletter" name="wf-form-Newsletter" data-name="Newsletter" method="get"
              class="form margin-bottom-small" data-wf-page-id="64cb35cd05058fe9b18f57c1"
              data-wf-element-id="c2864e63-da07-45d7-a893-74ed488cfc2d">
              <input type="text"
                class="text-field flex-white w-input" maxlength="256" name="First-Name" data-name="First Name"
                ...
                <input type="email"
                class="text-field flex-white w-input" maxlength="256" name="Email" data-name="Email"
                placeholder="Enter your email" id="Email-6" required=""><input type="submit" value="Get Started"
                data-wait="Please wait..." class="button plan w-button"></form>
