        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-40 lg-mb-30">
            ...
            <div class="d-flex ms-auto xs-mt-30">
                <div class="nav nav-tabs tab-filter-btn me-4" id="nav-tab" role="tablist">
                    ...
                    <button class="nav-link" data-bs-toggle="tab" data-bs-target="#a2" type="button" role="tab"
            ...
            <div class="table-responsive">
                <table class="table job-alert-table">
                    ...
                    <tbody class="border-0">
                        <tr class="active">
                            <td>
                                <div class="job-name fw-500">Zubayer Hasan</div>
                            ...
                            <td>
                                <div class="action-dots float-end">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="{{route('JobListingCandidate')}}"><img
                                                    src="../images/lazy.svg" data-src="images/icon/icon_18.svg" alt=""
                                                    class="lazy-img"> View</a></li>
                                        <li><a class="dropdown-item" href="#"><img src="../images/lazy.svg"
                                                    data-src="images/icon/icon_19.svg" alt="" class="lazy-img">
                                                Share</a></li>
                                        <li><a class="dropdown-item" href="#"><img src="../images/lazy.svg"
                                                    data-src="images/icon/icon_20.svg" alt="" class="lazy-img"> Edit</a>
                                        </li>
                                        <li><a class="dropdown-item" href="#"><img src="../images/lazy.svg"
                                                    data-src="images/icon/icon_21.svg" alt="" class="lazy-img">
                                                Delete</a></li>
                                    </ul>
                                </div>
                            </td>
                        ...
                        <tr class="expired">
                            ...
                            <td>Test@example.com</td>
                            <td>
                                <div class="job-status">Disabled</div>
                            </td>
                            <td>
                                <div class="action-dots float-end">
                                    <button class="action-btn dropdown-toggle" type="button" data-bs-toggle="dropdown"
