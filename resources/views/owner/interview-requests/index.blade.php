                        ...
                        <table class="table job-alert-table">
                            ...
                            <tbody class="border-0">
                                ...
                                <tr class="{{$status}}">
                                    ...
                                    <td><div class="job-application"><a href="{{route('companyAboutUs', \Crypt::encryptString($interview->requested_from))}}">{{$interview->employer->employerDetails->institution ?? ''}}</a><div></td>
                                    <td>
