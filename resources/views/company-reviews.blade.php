...
<nav class="nav-2" id="menu">
	<ul id="menu-closed">
		...
		<li> <a href="{{route('companyReviews')}}" class="active">Reviews and Testimonials</a></li>
			...
			<div class="col-xxl-9 col-xl-8 order-xl-first">
				<div class="details-post-data me-xxl-5 pe-xxl-4">
					...
					<div class="container">
						...
						<p>Parent Testimonials: (Short quotes from parents praising the school's methods, environment, or results)</p>
						<p>Teacher Testimonials: (Quotes from current or past teachers sharing their experiences)</p>
						<p>Student Success Stories: (Alumni who have gone on to do notable things, or students who have seen great academic/personal growth at the school)</p>
					</div>
				</div>
			</div>
		</div>
