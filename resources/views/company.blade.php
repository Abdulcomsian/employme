				...
				<div class="row">
					...
					<div class="col-xxl-9 col-xl-8 order-xl-first">
						<div class="details-post-data me-xxl-5 pe-xxl-4">
							...
							<div class="details">
								<p>
								<h5>School's Mission & Vision:</h5>(Brief overview of the school's guiding principles
								and aspirations)</p>
								<p>
								<h5>History: </h5>(A short description of the hagwon's history and evolution)</p>
								<p>
								<h5>Teaching Philosophy:</h5> (Details about the school's pedagogic beliefs and methods)
								</p>
							</div>


							<h3>School Facilities & Environment</h3>
							<div class="details">
								<p>
								<h5>Infrastructure:</h5>(Details about classrooms, teaching aids, laboratories,
								libraries, etc.)</p>
								<p>
								<h5>Recreational Areas: </h5>(Play areas, lounges, etc.)</p>
								<p>
								<h5>Technology Integration: </h5> (E.g., smartboards, online learning platforms,
								computer labs)</p>
								<p>
								<h5>Safety Measures: </h5>(CCTV, security personnel, fire safety equipment, etc.)</p>
							</div>


							<h3>Staff & Community</h3>
							<div class="details">
								<p>
								<h5>Faculty Overview:</h5> (Information about the credentials and experience of staff
								members, maybe spotlight a few key members)</p>
								<p>
								<h5>Community Activities: </h5>(Details of any events, festivals, or community outreach
								programs the school participates in or organizes)</p>
								<p>
								<h5>Professional Development:</h5> (Opportunities and programs for staff growth and
								development)</p>
							</div>
								...
								<div class="company-review-slider">
									<div class="item">
										<div class="feedback-block-four">
											<div class="name fw-500 text-dark">Biology</div>
									...
									<div class="item">
										<div class="feedback-block-four">
											<div class="name fw-500 text-dark">Chemistry</div>
											<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum
												perspiciatis atque consequuntur reiciendis sunt magnam.</p>
										</div>
									</div>
									<div class="item">
										<div class="feedback-block-four">
											<div class="name fw-500 text-dark">Physics</div>
											<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum
												perspiciatis atque consequuntur reiciendis sunt magnam.</p>
										</div>
									</div>
									<div class="item">
										<div class="feedback-block-four">
											<div class="name fw-500 text-dark">English</div>
											<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum
												perspiciatis atque consequuntur reiciendis sunt magnam.</p>
										</div>
									</div>
						...
						<div class="row justify-content-between align-items-center">
							<div class="col-xxl-3 col-lg-4">
								<div class="job-title d-flex align-items-center">
									<a href="job-details-v1.html" class="logo"><img src="images/lazy.svg"
											data-src="images/logo/media_22.png" alt="" class="lazy-img m-auto"></a>
									<a href="job-details-v1.html" class="title fw-500 tran3s">Developer & expert in java
										c++</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
								<a href="job-details-v1.html" class="job-duration fw-500">Fulltime</a>
								<div class="job-date">18 Jul 2018 by <a href="job-details-v1.html">slack</a></div>
							</div>
							<div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6 ms-auto xs-mt-10">
								...
								<div class="job-category">
									<a href="job-details-v1.html">Developer,</a>
									<a href="job-details-v1.html">Coder</a>
								</div>
							</div>
							<div class="col-lg-2 col-md-4">
								<div class="btn-group d-flex align-items-center justify-content-md-end sm-mt-20">
									<a href="job-details-v1.html"
										class="save-btn text-center rounded-circle tran3s me-3" title="Save Job"><i
					...
					<div class="job-list-one style-two position-relative mb-20">
						<div class="row justify-content-between align-items-center">
							<div class="col-xxl-3 col-lg-4">
								<div class="job-title d-flex align-items-center">
									<a href="job-details-v1.html" class="logo"><img src="images/lazy.svg"
											data-src="images/logo/media_23.png" alt="" class="lazy-img m-auto"></a>
									<a href="job-details-v1.html" class="title fw-500 tran3s">Animator & Expert in maya
										3D </a>
								</div>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
								<a href="job-details-v1.html" class="job-duration fw-500 part-time">Part time</a>
								<div class="job-date">18 Jul 2018 by <a href="job-details-v1.html">google</a></div>
							</div>
							<div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6 ms-auto xs-mt-10">
								<div class="job-location">
									<a href="job-details-v1.html">USA,New York</a>
								</div>
								<div class="job-category">
									<a href="job-details-v1.html">Finance,</a>
									<a href="job-details-v1.html">Accounting</a>
								</div>
							</div>
							<div class="col-lg-2 col-md-4">
								<div class="btn-group d-flex align-items-center justify-content-md-end sm-mt-20">
					...
					<div class="job-list-one style-two position-relative mb-20">
						<div class="row justify-content-between align-items-center">
							<div class="col-xxl-3 col-lg-4">
								<div class="job-title d-flex align-items-center">
									<a href="job-details-v1.html" class="logo"><img src="images/lazy.svg"
											data-src="images/logo/media_24.png" alt="" class="lazy-img m-auto"></a>
									<a href="job-details-v1.html" class="title fw-500 tran3s">Marketing Specialist in
										SEO & SMM</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
								<a href="job-details-v1.html" class="job-duration fw-500 part-time">Part time</a>
								<div class="job-date">18 Jul 2018 by <a href="job-details-v1.html">pinterest</a></div>
							</div>
							<div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6 ms-auto xs-mt-10">
								<div class="job-location">
								...
								<div class="job-category">
									<a href="job-details-v1.html">Design,</a>
									<a href="job-details-v1.html">Artist</a>
								</div>
							</div>
							<div class="col-lg-2 col-md-4">
								<div class="btn-group d-flex align-items-center justify-content-md-end sm-mt-20">
					...
					<div class="job-list-one style-two position-relative mb-20">
						<div class="row justify-content-between align-items-center">
							<div class="col-xxl-3 col-lg-4">
								<div class="job-title d-flex align-items-center">
									<a href="job-details-v1.html" class="logo"><img src="images/lazy.svg"
											data-src="images/logo/media_25.png" alt="" class="lazy-img m-auto"></a>
									<a href="job-details-v1.html" class="title fw-500 tran3s">Developer & Expert in java
										c++.</a>
								</div>
							</div>
							<div class="col-lg-3 col-md-4 col-sm-6 ms-auto">
								<a href="job-details-v1.html" class="job-duration fw-500">Fulltime</a>
								<div class="job-date">18 Jul 2018 by <a href="job-details-v1.html">instagram</a></div>
							</div>
							<div class="col-xxl-2 col-lg-3 col-md-4 col-sm-6 ms-auto xs-mt-10">
								<div class="job-location">
								...
								<div class="job-category">
									<a href="job-details-v1.html">Application,</a>
									<a href="job-details-v1.html">Dev</a>
								</div>
							</div>
							<div class="col-lg-2 col-md-4">
								<div class="btn-group d-flex align-items-center justify-content-md-end sm-mt-20">
