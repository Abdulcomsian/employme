...
<head>
  ...
  <meta
    content="Mollie is a refined Webflow template focused on SaaS Tech companies that are eager to stand out in the crowd. A practical and versatile design to reach clients seeking outstanding visual businesses."
    name="description">
  ...
  <script
    type="text/javascript">WebFont.load({ google: { families: ["Inter:regular,500,600,700,800,900:latin,latin-ext", "Inter:100,200,300,regular", "IBM Plex Mono:regular,500,600"] } });</script>
  <script
  ...
  <nav class="wrappernav">
    <div data-collapse="medium" data-animation="default" data-duration="400" data-easing="ease" data-easing2="ease"
      ...
      <div class="w-layout-grid navgrid">
        ...
        <a href="/" class="grid-wrapper logo"><strong
            style="font-size:x-large;">EmployMe</strong></a>
                ...
                <nav class="dropdown-list w-dropdown-list">
                  <div class="w-layout-grid dropdown-grid">
                    <div>
                      ...
                      <a href="about-us" class="dropdown-link w-dropdown-link"
                        class="dropdown-link w-dropdown-link">About Us</a>
        ...
        <div id="w-node-b2052354-5446-da9c-e906-f9d98118b8c9-8118b8ae" data-w-id="b2052354-5446-da9c-e906-f9d98118b8c9"
          class="menu-button w-nav-button">
          <div class="menu-mobile">
            <div data-w-id="95a6b465-b1f6-32c9-f1ca-4e8c429efe2f" data-is-ix2-target="1" data-animation-type="lottie"
              data-src="{{asset('assets/documents/lf30_editor_0dtgjm93.json')}}"   data-loop="0" data-direction="1" data-autoplay="0"
              data-renderer="svg" data-default-duration="1.5015014403440954" data-duration="0"
              data-ix2-initial-state="25"></div>
          </div>
        </div>
        <div id="w-node-_789e96f7-0420-3c9a-0cb2-d06ac7c188e8-8118b8ae" class="chart-wrapper">
          <div data-node-type="commerce-cart-wrapper" id="w-node-e04907a7-3dd8-600d-1639-7c7828a70341-8118b8ae"
            data-open-product="" data-wf-cart-type="modal" data-wf-cart-query="" data-wf-page-link-href-prefix=""
            class="w-commerce-commercecartwrapper button-cart">
            <a href="#" data-node-type="commerce-cart-open-link"
              ...
              aria-label="Open cart"><svg class="w-commerce-commercecartopenlinkicon icon-cart" width="17px"
            ...
            <div data-node-type="commerce-cart-container-wrapper" style="display:none"
              ...
              <div data-node-type="commerce-cart-container" role="dialog"
                class="w-commerce-commercecartcontainer cart-container rounded">
                <div class="w-commerce-commercecartheader cart-header">
                  ...
                  <a href="#" data-node-type="commerce-cart-close-link"
                    class="w-commerce-commercecartcloselink w-inline-block" role="button" aria-label="Close cart"><svg
                ...
                <div class="w-commerce-commercecartformwrapper">
                  <form data-node-type="commerce-cart-form" style="display:none"
                    class="w-commerce-commercecartform default-state-nav">
                    ...
                    <div class="w-commerce-commercecartlist" data-wf-collection="database.commerceOrder.userItems"
                      data-wf-template-id="wf-template-e04907a7-3dd8-600d-1639-7c7828a70350"></div>
                    <div class="w-commerce-commercecartfooter">
                      ...
                      <div>
                        ...
                        <a href="../checkout.html" value="Continue to Checkout" data-node-type="cart-checkout-button"
                          class="w-commerce-commercecartcheckoutbutton button color-blue"
...
@yield('content')
      ...
      <div class="container footer w-container">
        <div class="w-layout-grid main-grid inner-padding-medium">
          <div id="w-node-_2bca43ef-7cde-b5da-b1b2-716107bf8e46-07bf8e43" class="grid-wrapper padding-bottom-small">
            <strong data-w-id="abdbb472-4b00-3ed8-42ca-09cb022d060c"
              data-wf-id="[&quot;3bce2b2b-97ed-9e60-d10f-53aeb3201909&quot;,&quot;abdbb472-4b00-3ed8-42ca-09cb022d060c&quot;]"
              style="font-size:x-large;">EmployMe</strong>
            ...
            <div class="form-wrapper">
              <div class="full-form w-form">
                <form id="wf-form-Email-Hero" name="wf-form-Email-Hero" data-name="Email Hero" method="get"
                  class="form single" data-wf-page-id="64cb35cd05058fe9b18f5848"
                  data-wf-element-id="f74a4ca7-e334-6206-b99d-41381ef509ad"><input type="email"
                    class="text-field small w-input" maxlength="256" name="Email-5" data-name="Email 5"
                    placeholder="Enter your email" id="Email-5" required=""><input type="submit" value=""
                    data-wait="Please wait..." class="button-circle-small w-button"></form>
          ...
          <div id="w-node-_2bca43ef-7cde-b5da-b1b2-716107bf8e80-07bf8e43" class="footer-inner">
            <div class="small-legal-text">© Employme — South Korea <a href="http://www.webflow.com" target="_blank"
                class="link"></a>
            </div>
          ...
          <div id="w-node-_2bca43ef-7cde-b5da-b1b2-716107bf8e83-07bf8e43" class="footer-inner">
            <div class="w-layout-grid grid-buttons social">
              <a id="w-node-_2bca43ef-7cde-b5da-b1b2-716107bf8e85-07bf8e43" href="#"
                class="link-icons center w-inline-block"><img src="{{asset('assets/images/instagram-icon.svg')}}" loading="lazy" alt=""
                  class="icon-social"></a>
              <a href="#" class="link-icons center w-inline-block"><img src="{{asset('assets/images/facebook-icon.svg')}}" loading="lazy"
                  alt="" class="icon-social"></a>
              <a href="#" class="link-icons center w-inline-block"><img src="{{asset('assets/images/linkedin-icon.svg')}}" loading="lazy"
                  alt="" class="icon-social"></a>
              <a href="#" class="link-icons center w-inline-block"><img src="{{asset('assets/images/twitter-icon.svg')}}" loading="lazy"
                  alt="" class="icon-social"></a>
            </div>
          </div>
          <div id="w-node-_2bca43ef-7cde-b5da-b1b2-716107bf8e4a-07bf8e43" class="w-layout-grid inner-footer-nav">
            <div id="w-node-_2bca43ef-7cde-b5da-b1b2-716107bf8e4b-07bf8e43" class="grid-wrapper">
              <ul role="list" class="w-list-unstyled">
                ...
                <li>
                  <a href="" class="link-footer">Jobs Marketplace</a>
                </li>
                <li>
            ...
            <div id="w-node-_2bca43ef-7cde-b5da-b1b2-716107bf8e5c-07bf8e43" class="grid-wrapper">
              <ul role="list" class="w-list-unstyled">
                ...
                <li>
                  <a href="" class="link-footer">Candidate Marketplace</a>
                </li>
                <li>
            ...
            <div id="w-node-_2bca43ef-7cde-b5da-b1b2-716107bf8e6d-07bf8e43" class="grid-wrapper">
              <ul role="list" class="w-list-unstyled">
                <li>
                  <h4 class="heading-small">Help</h4>
                </li>
                <li>
                  <a href="terms-of-services" class="link-footer">Terms of service</a>
                </li>
                <li>
                  <a href="../utility/licenses.html" class="link-footer">Privacy policy</a>
                </li>
                <li>
  ...
  <script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=64cb35cd05058fe9b18f5745"
